...
const Feedback = () => {
  ...
  if (!currentUser) {
    return (
      <div className="min-h-screen flex items-center justify-center pb-24" style={{ background: theme.colors.background }}>
  ...
  return (
    <div className="pb-20" style={{ background: theme.colors.background }}>
      {/* Header */}
      <div className="px-4 sm:px-6 py-4 sm:py-6 border-b" style={{ background: theme.colors.card, borderColor: theme.colors.border }}>
      ...
      <div className="px-4 sm:px-6 py-6 max-w-2xl mx-auto">
        ...
        >
          {/* Meal Details Card */}
          <div className="rounded-2xl p-4 sm:p-6 space-y-4" style={{ background: theme.colors.card, border: `1px solid ${theme.colors.border}` }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 text-sm sm:text-base rounded-lg border-2"
                  style={{
              ...
              <div className="sm:col-span-2">
                ...
                <div className="relative">
                  <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: theme.colors.textSecondary }} />
                  <input
                    type="date"
                    value={formData.date}
                    onChange={(e) => setFormData({ ...formData, date: e.target.value })}
                    className="w-full pl-10 pr-3 py-2 text-sm sm:text-base rounded-lg border-2"
                    style={{
                      background: theme.colors.backgroundSecondary,
                      color: theme.colors.text,
                      borderColor: theme.colors.border,
          ...
          <div className="rounded-2xl p-4 sm:p-6 space-y-4" style={{ background: theme.colors.card, border: `1px solid ${theme.colors.border}` }}>
            ...
            <div>
              <textarea
                ...
                rows={5}
                maxLength={1500}
                className="w-full px-3 py-2 text-sm sm:text-base rounded-lg border-2 resize-none"
                style={{
                  background: theme.colors.backgroundSecondary,
                  color: theme.colors.text,
                  borderColor: theme.colors.border,
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <label htmlFor="anonymous" className="text-xs sm:text-sm" style={{ color: theme.colors.text }}>
                Submit anonymously
              </label>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full px-4 py-3 sm:py-4 rounded-xl sm:rounded-2xl text-white font-semibold text-sm sm:text-base flex items-center justify-center gap-2 transition-all"
            style={{
